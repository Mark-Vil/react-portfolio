...
const Header = ({ onAboutClick }) => {
  ...
  <a href="https://github.com/Mark-Vil" target="_blank" rel="noopener noreferrer" className="social-link">
  ...
  <a href="https://web.facebook.com/Nocalan.Mark.007/" target="_blank" rel="noopener noreferrer" className="social-link">
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
