...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const serviceId = 'service_hxxlvh3';
    const templateId = 'template_yci3jzt';
    const publicKey = 'g0gKjWorzV8OYszok';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
          ...
          data-aos-delay="400">
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="flex flex-col gap-6">
              ...
              {/* Response message */}
              {response.show && (
                <div className={`p-3 rounded-md ${response.success ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
                  {response.message}
                </div>
              )}
