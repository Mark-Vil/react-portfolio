        ...
        <div className="flex flex-col lg:flex-row items-center justify-center w-full gap-8 lg:gap-16">
          ...
          >
            <img 
              src={chillImage} 
              alt="James" 
              // Corresponds to .hero-image
              className="w-full h-full object-cover rounded-full"
              width="560" // Keep original width/height attributes for performance/layout shift prevention
              height="560"
            />
          </div>
          
          {/* Corresponds to .hero-text-wrapper */}
          <div className="w-full max-w-md lg:w-auto lg:max-w-[600px] flex flex-col items-center text-center lg:items-start lg:text-left py-6 lg:py-8">
            {/* Corresponds to .hero-title-wrapper */}
            <div className="w-full" data-aos="fade-left" data-aos-delay="400">
              {/* Corresponds to .hero-title - Increased bottom margin significantly */}
              <h1 className="inline-block w-full text-[#1B1B1B] font-bold capitalize text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem] z-10 leading-tight sm:leading-snug md:leading-normal lg:leading-[50px]"> 
                {/* Spans for potential animation/styling if needed, kept structure */}
                <span className="inline-block mr-2">I'm</span> 
                <span className="inline-block">Mark Villiones</span>
              </h1>
            </div>
            
            {/* Corresponds to .hero-subtitle - Increased vertical margin significantly */}
            <p 
            ...
            {/* Corresponds to .hero-cta - Increased top margin significantly */}
            <div 
              className="flex items-center self-center lg:self-start" 
              data-aos="fade-left" 
              data-aos-delay="800"
            >
              {/* Corresponds to .resume-button */}
              <a 
              ...
              {/* Corresponds to .contact-link - Increased left margin significantly */}
              <a 
                href="mailto:markvil64@gmail.com" 
